...
mod tests {
    ...
    #[test]
    fn test_total() {
        assert_eq!(get_answer("111111-111111"), Some(1));
        assert_eq!(get_answer("223450-223450"), Some(0));
        assert_eq!(get_answer("123789-123789"), Some(0));
        assert_eq!(get_answer(include_str!("../assets/day04_input.txt")), Some(945));
    }
}
